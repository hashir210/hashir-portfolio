...
export default function Navbar() {
  return (
    <header className="w-full py-5 px-6 sm:px-12 border-b border-editorial-border bg-warm-bg sticky top-0 z-50 flex flex-col md:flex-row items-center justify-between gap-4">
      {/* Left status badge */}
      <div className="md:flex-1 flex justify-start items-center gap-2">
      ...
      <nav className="md:flex-1 flex justify-center items-center gap-6 sm:gap-8 font-mono text-xs uppercase tracking-widest">
        <Link
          href="/#about"
